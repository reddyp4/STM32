...
void spi_init(void)
{
    ...
    MISO:   PA6
    */
   __HAL_RCC_GPIOA_CLK_ENABLE();    //Select Pad-A
...
void spi_interrupt_init(void)
{
   ...
   hgpio1.Pull = GPIO_NOPULL;
   hgpio1.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
   hgpio1.Alternate = GPIO_AF0_SPI1; //GPIO_AF0_SPI1;                //As per datasheet
   //HAL_GPIO_Init(GPIO_TypeDef  *GPIOx, GPIO_InitTypeDef *GPIO_Init)
   HAL_GPIO_Init(GPIOA, &hgpio1);
...
void spi_interrupt_spi1_init2(void)
{
   ...
   __HAL_RCC_GPIOA_CLK_ENABLE();    //Select Pad-A
   GPIO_InitTypeDef hgpio1={0};
   hgpio1.Pin = GPIO_PIN_1|GPIO_PIN_11|GPIO_PIN_12;   //SCK/MOSI/MISO
   hgpio1.Mode = GPIO_MODE_AF_PP;
   hgpio1.Pull = GPIO_NOPULL;
   hgpio1.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
   hgpio1.Alternate = GPIO_AF0_SPI1; //GPIO_AF0_SPI1;                //As per datasheet
